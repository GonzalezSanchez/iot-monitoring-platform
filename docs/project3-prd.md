...
Build contract for project 3b. Base spec: [project3b-iot-gateway.md](project3b-iot-gateway.md)
...
New directory `backend/project3b-iot-gateway/` with `src/gateway/` (FastAPI app),
